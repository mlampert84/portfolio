...
const paragraphs = [
  ...
  "If you are interested in what I do, where I come from, and the kinds of projects I've worked on, then keep reading.",
  ...
  "For the last five years, I've been writing software at a research institute (the Berlin-Brandenburg Academy of Sciences, i.e. BBAW) that is dedicated to projects in and adjacent to the humanities. Projects at the Academy include things like online and print critical editions of famous writers (for example: Leibniz, Schleiermacher, Marx, Galen of Pergamon, etc), and centralized databases of archaeological objects (for example: ancient Greek and Latin inscriptions, Quran manuscripts, cylinder seals from ancient Near East cuneiform civilizations).",
